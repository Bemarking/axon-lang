...
> 10 sub-fases SHIPPED (a, b, c, d, e, f, g.1, g.2, g.3, h); 5 sub-fases pendientes.
...
| _(this commit)_ | 33.z.k.h algebraic-policy surfacing per dialect (populated metadata frames) |
