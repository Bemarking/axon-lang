//! §Fase 111 (Tier 2) — the retractions: `logic` · `apx` · `taint` · `transact` · `corroborate`.
//!
//! §111's diagnostic walked every primitive the public README advertises and
...
//!
//! The §108 precedent applies (`dataspace` was a no-op; `ingest` hallucinated):
...
/// `primitive_registry` had already deleted its entry in §Fase 6.d.
///
