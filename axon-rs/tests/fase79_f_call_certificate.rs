//! §Fase 79.f (OSS core) — the unified `CallSoundnessCertificate` +
//! `ParkedResidualSoundness`.
//!
//! Interruption opens a data-at-rest surface (the parked κ persisted into the
//! §41.g cognitive_state snapshot). The certificate composes, for one socket
...
//! conjunction). The enterprise serving endpoint (§79.f ENT) rides this core.
